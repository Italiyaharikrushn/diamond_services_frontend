...
const SortableItem = ({ id, shape, onCheckboxChange, onDelete }) => {
        ...
        >
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                <Box sx={{ border: '1px solid #e0e0e0', borderRadius: 1, width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <img src={shape.url} alt={shape.label} style={{ width: '24px', height: '24px' }} />
                </Box>
                {/* <IconButton 
                    size="small" 
...
const SortableList = ({ items, onReorder, onCheckboxChange }) => {
